module github.com/rx-refill-reminders/users/presignup-lambda/src

go 1.25.0

require (
	github.com/aws/aws-lambda-go v1.54.0
	github.com/rx-refill-reminders/lambda-go v0.0.0
	github.com/rx-refill-reminders/users/handler-utils v0.0.0
...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.8.41 // indirect
